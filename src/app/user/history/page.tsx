        ...
        <div className="space-y-10 animate-in">
            <div className="flex items-center justify-between px-2">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative group w-64">
                        ...
                        <Input placeholder="Search records..." className="pl-12 h-11 bg-white border-zinc-100 shadow-sm" />
                    </div>
                    <Button variant="secondary" className="h-11 font-black shadow-sm">
            ...
            <Card className="border-transparent shadow-premium overflow-hidden">
                <CardHeader
                    ...
                    subtitle="Historical record of all your digital cheque submissions"
                    action={
                        <div className="flex items-center gap-2 text-[10px] font-black text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-full border border-indigo-100 uppercase tracking-widest">
